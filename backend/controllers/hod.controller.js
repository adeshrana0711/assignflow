...
export const getHodDashboard = async (req, res) => {
  try {
    ...
    const assignmentsWithStudent = assignments.map((assignment) => {
      ...
      assignmentData.department = assignment.studentId?.department || "Unknown";
    ...
    res.render("hod/dashboard", {
      assignments: assignmentsWithStudent,
      pending,
      reviewed,
